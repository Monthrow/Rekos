        ...
        <aside class="bg-[#0B132B] border-r border-slate-800/60 h-full flex flex-col justify-between overflow-hidden">
            ...
            <div class="p-6 bg-[#0B132B] border-t border-slate-800/60 shadow-[0_-8px_20px_rgba(0,0,0,0.3)]">
                <form action="{{ route('logout') }}" method="POST" class="m-0">
                    @csrf
                    <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-950/40 text-red-400 border border-red-900/30 hover:bg-red-900/40 hover:text-red-300 transition font-bold text-xs rounded-xl">
