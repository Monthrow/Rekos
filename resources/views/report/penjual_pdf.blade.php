...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-box { flex: 1; background: #f1f5f9; border-left: 4px solid #2563eb; padding: 12px; border-radius: 6px; }
...
<body>
    ...
    <div class="header">
        <h1>Laporan Penjualan - REKOS</h1>
        <p>Penjual: {{ $user->username }} &nbsp;|&nbsp; Dicetak: {{ now()->format('d/m/Y H:i') }}</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" style="text-align:center; color:#94a3b8; padding:20px;">Belum ada transaksi</td>
            </tr>
            @endforelse
        </tbody>
    </table>

    <div class="footer">REKOS - Rekayasa Kos &nbsp;|&nbsp; {{ now()->format('Y') }}</div>
